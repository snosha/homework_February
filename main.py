...
if __name__ == "__main__":
    ...
    # Проверка сложения одинаковых классов
    print(smartphone1 + smartphone2)
    print(grass1 + grass2)

    # Проверка ошибки сложения разных классов
    try:
    ...
    # Проверка общего количества продуктов в категории
    print(category_smartphones.total_quantity)
